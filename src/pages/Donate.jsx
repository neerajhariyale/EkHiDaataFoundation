  ...
  return (
    <div className="w-full min-h-screen  flex flex-col justify-center items-center ">
      ...
      <h1 className="text-2xl sm:text-4xl font-semibold text-center   mb-4">
        "Your small help can{" "}
        <span className="text-red-500">make a big difference."</span>
      </h1>
      <p className="text-center text-gray-700 max-w-xl mb-8">
        Every rupee you donate brings us one step closer to changing someone's
        life. Help us spread kindness, hope, and opportunity.
      </p>
